  ...
  return (
    <div className="min-w-0 overflow-hidden rounded-2xl border border-primary-border bg-surface shadow-[0_14px_40px_-26px_rgba(15,76,129,.4)]">
      <div className="flex items-center gap-2.5 bg-primary px-5 py-[15px]">
        ...
        <span className="font-mono text-[11.5px] font-semibold tracking-[.08em] text-primary-foreground uppercase">
          AI Explanation · Q14
        </span>
      </div>
      <div className="flex flex-col gap-3.5 p-5">
        ...
        <div className="rounded-[11px] border border-brand-accent-border bg-brand-accent-tint p-3.5">
          ...
          <p className="mt-1.5 text-[14.5px] leading-snug text-brand-accent-text">
        ...
        <div className="flex flex-wrap items-center gap-2.5 pt-0.5">
          ...
          <span className="inline-flex items-center gap-1.5 rounded-[9px] bg-primary px-4 py-3 text-sm font-bold text-primary-foreground">
            Ask AI
