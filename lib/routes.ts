...
export const ROUTE_MANIFEST: RouteManifestEntry[] = [
  ...
  { pageName: "Mock Test Details / Instructions", route: "/student/test-series/[mockTestId]", module: "Test Flow", userType: "STUDENT", authRequired: true, parentRoute: "/student/test-series", status: "CONNECTED" },
  { pageName: "Subject Test", route: "/student/subject-test", module: "Student Dashboard", userType: "STUDENT", authRequired: true, parentRoute: "/student/dashboard", status: "CONNECTED" },
  { pageName: "Subject Test Builder", route: "/student/subject-test/[examId]", module: "Test Flow", userType: "STUDENT", authRequired: true, parentRoute: "/student/subject-test", status: "CONNECTED" },
