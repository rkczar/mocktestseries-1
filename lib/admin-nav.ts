...
export const ADMIN_NAV: AdminNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Subjects", href: "/admin/exams/subjects", status: "live" },
      { label: "Topics", href: "/admin/exams/topics", status: "live" },
  ...
  },
  {
    ...
    icon: HelpCircle,
    items: [
      { label: "All Questions", href: "/admin/questions", status: "live" },
      { label: "Add Questions", href: "/admin/questions/add", status: "live" },
      ...
      { label: "Question Reports", href: "/admin/questions/reports", status: "live" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Mock Tests", href: "/admin/tests/mock", status: "live" },
  ...
  },
  {
    ...
    icon: ListChecks,
    items: [{ label: "Custom Modules", href: "/admin/custom-modules", status: "live" }],
  },
  {
    label: "Students",
    icon: Users,
    items: [
      { label: "All Students", href: "/admin/students", status: "live" },
      { label: "Test History", href: "/admin/students/history", status: "live" },
      { label: "Attempted Questions", href: "/admin/students/attempted", status: "live" },
      { label: "Deletion Requests", href: "/admin/students/deletion-requests", status: "live" },
    ],
  },
  {
    label: "AI",
