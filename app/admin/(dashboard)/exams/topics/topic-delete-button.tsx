...
export function TopicDeleteButton({ topicId }: { topicId: string }) {
  ...
  return (
    <div className="flex flex-col items-end gap-1">
      <Button type="button" size="compact" variant="ghost" onClick={handleClick} disabled={isPending} aria-label="Delete topic">
