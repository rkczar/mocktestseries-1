...
export function RegistryTable({ entries }: { entries: DiagramEntry[] }) {
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <p className="text-sm text-[var(--color-muted-foreground)]">
          Live registry of every page — route, module, parent, user type, auth requirement, and connection status.
          Sourced from <code className="text-xs">lib/routes.ts</code>, seeded into the database.
        </p>
        <CheckButton />
      </div>
