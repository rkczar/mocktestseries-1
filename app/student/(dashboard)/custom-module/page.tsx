...
import { getPublishedCustomModulesForStudent } from "@/lib/student-data";
...
export default async function CustomModuleListPage() {
  ...
  const rows = await getPublishedCustomModulesForStudent(student.id);
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="text-sm text-[var(--color-muted-foreground)]">Focused practice sets curated by Admin.</p>
      </div>
